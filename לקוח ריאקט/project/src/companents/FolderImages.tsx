...
// import { Box, Container, Typography, Button, Alert, Paper, Fab, IconButton } from "@mui/material"
...
//       try {
//         // Fetch album details
//         const albumResponse = await axios.get(`https://localhost:7259/api/Album/${folderId}`, {
...
//     try {
//       await axios.put(
//         `https://localhost:7259/api/Photo/${image.photoId}`,
//         {
//           ...image,
//           title: newTitle,
...
//           <Alert severity="error" sx={folderImagesStyles.errorAlert}>
//             שגיאה: {error}
//           </Alert>
//         </Container>
//       </Box>
...
const FolderImages: React.FC = () => {
  ...
  const handleDeleteImage = async () => {
    ...
    try {
      await axios.delete(`https://localhost:7259/api/Photo/${imageToDelete}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
